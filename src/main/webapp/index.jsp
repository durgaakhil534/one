...
<head>
  ...
  <title>NexusShopping · friendly e‑commerce</title>
  <!-- Fonts & Icons -->
  ...
  <style>
    ...
    :root {
      ...
      --shadow-hover: 0 20px 32px rgba(0, 0, 0, 0.06), 0 8px 16px rgba(0, 0, 0, 0.03);
    ...
    * {
    ...
    .btn-primary {
      ...
      box-shadow: 0 8px 18px -6px rgba(224, 122, 95, 0.35);
    }
    ...
    .btn-primary:hover {
      ...
      box-shadow: 0 12px 22px -8px rgba(224, 122, 95, 0.45);
    }
...
<script>
  ...
  console.log('🚀 NexusShop — friendly e‑commerce demo loaded.');
</script>
